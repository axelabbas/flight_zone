...
import 'package:flight_zone/core/networking/errors/error_constants.dart';
import 'package:flight_zone/core/networking/errors/error_model.dart';
enum DataSource {
  NO_CONTENT,
  BAD_REQUEST,
  FORBIDDEN,
...
class ErrorHandler implements Exception {
  ...
  ErrorHandler.handle(dynamic error) {
    if (error is DioException) {
      ...
      failure = ApiErrorModel(message: error.toString());
    }
  }
}
